...
def draw_labels():
    ...
    # Draw currently annotating rectangle
    if len(points) == 2:
...
def main():
    ...
    print("  W: Label as White (live sperm)")
    print("  P: Label as Pink (fragmented sperm)")
